...
class RobertaForSequenceClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        sequence_output = outputs[0]
        # ThangPM: outputs[0][:, 0, :] vs outputs[1] -> What are differences? They all represent for [CLS] embedding.
        # sentence_embs = outputs[1] <-- Implementation does not use this!!!
        sentence_embs = outputs[0][:, 0, :]
