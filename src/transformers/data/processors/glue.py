...
def _glue_convert_examples_to_features(
    ...
    # ThangPM's NOTE 06-16-20
    # Temporarily ignore logger here
...
class MnliProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        # ThangPM: Temporarily fixed for ANLI
        return ["c", "e", "n"] # For our finetuned RoBERTa-base model.
        # return ["e", "c", "n"] # For ANLI authors' finetuned RoBERTa-large model.
